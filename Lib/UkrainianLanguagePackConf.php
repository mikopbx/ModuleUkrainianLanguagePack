...
namespace Modules\ModuleUkrainianLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleUkrainianLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * UkrainianLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class UkrainianLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-ukrainian-language-pack';
