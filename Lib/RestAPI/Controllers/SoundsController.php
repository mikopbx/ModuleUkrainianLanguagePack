...
namespace Modules\ModuleUkrainianLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-ukrainian-language-pack/sounds
 *   GET /pbxcore/api/v3/module-ukrainian-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleUkrainianLanguagePack';
