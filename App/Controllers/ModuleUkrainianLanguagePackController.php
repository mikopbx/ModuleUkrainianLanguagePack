...
namespace Modules\ModuleUkrainianLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleUkrainianLanguagePackController
 *
 * Controller for Ukrainian Language Pack module information page
 */
class ModuleUkrainianLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleUkrainianLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/uk-ua';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/uk';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-ukrainian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-ukrainian-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-ukrainian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-ukrainian-language-pack-sounds-index.js", true);
