...
namespace Modules\ModuleUkrainianLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Ukrainian Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Ukrainian UI translations from Messages/uk/ directory
 * - Ukrainian voice prompts from Sounds/uk-ua/ directory
 *
 ...
 *
 * @package Modules\ModuleUkrainianLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleUkrainianLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Ukrainian packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Ukrainian Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Ukrainian Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Ukrainian Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Ukrainian Language Pack uninstalled successfully',
            LOG_INFO
        );
